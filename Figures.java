...
public class Figures {
    ...
    public static void main (String[]args) {
        ...
        while (n % 2 == 0) {
            ...
            System.out.println ("!!  Invalid figure size (odd numbers only please)  !!");
            
            System.out.println ("What size fugure would you like? (odd numbers only): ");
    ...
    private static void printMenu () {
    	...
    	System.out.println ("What Figure Would You Like To Print?");
    	
    	System.out.println("");
        
        System.out.println ("1) A Box");
        
        System.out.println ("2) A Diamond");
